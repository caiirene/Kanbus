...
function EncodingParametersInURLs() {
  ...
  const fetchSum = async (a, b) => {
    const response = await
      axios.get(`http://five610-node-caiirene.onrender.com/a5/add/${a}/${b}`);
    setResult(response.data);
  };
  const fetchSubtraction = async (a, b) => {
    const response = await axios.get(
      `http://five610-node-caiirene.onrender.com/a5/subtract/${a}/${b}`);
    setResult(response.data);
  };
  ...
  const fetchWelcome = async () => {
    const response = await axios.get("http://five610-node-caiirene.onrender.com/a5/welcome");
  ...
  return (
    <div>
      ...
      <a
        href={`http://five610-node-caiirene.onrender.com/a5/add/${a}/${b}`}
        className="btn btn-danger">
        Add {a} + {b}
      </a>
      <a
        href={`http://five610-node-caiirene.onrender.com/a5/subtract/${a}/${b}`}
        className="btn btn-danger">
        Substract {a} - {b}
      </a>
      ...
      <a
        href={`http://five610-node-caiirene.onrender.com/a5/calculator?operation=add&a=${a}&b=${b}`}
        className="btn btn-danger">
        Add {a} + {b}
      </a>
      <a
        href={`http://five610-node-caiirene.onrender.com/a5/calculator?operation=subtract&a=${a}&b=${b}`}
        className="btn btn-danger">
        Substract {a} - {b}
      </a>
      <br /><br />
